from aim.utils import DetectionModel, VideoAnalysis
...
class MMDetection(DetectionModel):
    ...
    def __call__(self, *args, **kwargs):
        ...
        # bboxes = []
        # for i, bbs in enumerate(bbox_result):
        #     for bb in bbs:
        #         bboxes.append((i, bb[-1], int(bb[0]), int(bb[1]), int(bb[2] - bb[0]), int(bb[3] - bb[1])))
        ...
        # for bbox in bboxes:
        #     obj = dict()
        #     obj['category_id'] = bbox[0]
        #     obj['score'] = bbox[1]
        #     obj['bbox'] = [bbox[2], bbox[3], bbox[4], bbox[5]]
        #     results.append(obj)
